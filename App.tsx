          ...
          <div className="max-w-4xl w-full tech-border bg-slate-900 border-cyan-500/20 shadow-[0_0_100px_rgba(0,245,255,0.1)] relative tech-chipped max-h-[90vh] flex flex-col">
            ...
            <div className="p-4 md:p-8 flex-1 overflow-y-auto custom-scrollbar space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 ...
                 <div className="space-y-6">
                    <h3 className="mono text-xs font-black text-cyan-400 uppercase tracking-widest border-l-2 border-cyan-500 pl-4">Search_Memory</h3>
                    <div className="space-y-3">
            ...
            <div className="p-4 md:p-8 border-t border-white/5 bg-black/20 flex justify-between items-center">
               ...
               <div className="mono text-[8px] text-slate-600 uppercase font-black">Node_Vector_ID: {user?.id?.slice(0, 12)}</div>
            </div>
          </div>
        </div>
      )}
                              ...
                              <div className="flex flex-col items-start md:items-end gap-2">
                                <div className="relative">
                                  <button 
                                    ...
                                    className={`px-6 py-2 border mono font-black text-xs uppercase tracking-widest transition-all tech-chipped ${
                                      importSuccess 
                                ...
                                { label: 'Modality', component: (
                                    <div className="flex w-full p-1 bg-black/40 border border-white/10 h-[52px] tech-chipped">
                                        ...
                                        <button 
                                            ...
                                            className={`flex-1 flex items-center justify-center mono text-[10px] font-black uppercase transition-all ${
                                            state.filters.type === ct.value ? 'bg-cyan-500/20 text-cyan-400' : 'text-slate-500'
                                            }`}
                                        >
                                            {ct.label}
                                        </button>
