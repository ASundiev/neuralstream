...
const Illustration: React.FC<{ type: 'synthesis' | 'dna' | 'tuning' }> = ({ type }) => {
  if (type === 'synthesis') {
    ...
    return (
      <svg viewBox="0 0 100 100" className="w-full h-full p-1">
        ...
        <rect x="22" y="32" width="6" height="6" className="fill-slate-900 stroke-cyan-500/60" strokeWidth="0.5" />
        <rect x="72" y="32" width="6" height="6" className="fill-slate-900 stroke-cyan-500/60" strokeWidth="0.5" />
        <rect x="22" y="72" width="6" height="6" className="fill-slate-900 stroke-cyan-500/60" strokeWidth="0.5" />
        <rect x="72" y="72" width="6" height="6" className="fill-slate-900 stroke-cyan-500/60" strokeWidth="0.5" />
  ...
  return (
    <svg viewBox="0 0 100 100" className="w-full h-full p-1">
      ...
      <rect x="15" y="20" width="3" height="3" className="fill-cyan-500/20" />
      <rect x="82" y="20" width="3" height="3" className="fill-cyan-500/20" />
    </svg>
  );
};
