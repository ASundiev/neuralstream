        ...
        <div className="relative">
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute bottom-full right-0 mb-2 w-60 bg-[rgba(4,12,31,0.8)] backdrop-blur-md border border-white/10 shadow-2xl z-[60] py-1 animate-in fade-in slide-in-from-bottom-2 duration-200 rounded-sm">
                ...
                <button
                  ...
                  className="w-full text-left px-3 h-[40px] flex items-center mono text-[12px] leading-[24px] uppercase font-black text-[#8295b1] hover:text-cyan-400 hover:bg-white/5 transition-colors border-t border-white/5 mt-2"
