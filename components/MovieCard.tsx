          ...
          <div className="pt-3 border-t border-white/5 space-y-4 flex-1 flex flex-col justify-between">
            ...
            <div className="space-y-2 pt-2 relative z-20">
              {showReasonInput ? (
                ...
                <div className="py-2 border border-white/10 bg-white/5 flex items-center justify-center gap-2 tech-chipped">
                  <i className={`fa-solid ${movie.feedback.type === 'like' ? 'fa-thumbs-up text-cyan-500' : 'fa-thumbs-down text-red-500'} text-xs`}></i>
                  <span className="mono text-[9px] text-slate-400 uppercase tracking-widest">FEEDBACK_RECORDED</span>
                </div>
              ) : (
                <div className="flex gap-1.5">
                  <button 
                  ...
                  <div className="relative">
                    <button 
                      ...
                      className="px-4 py-2.5 border border-white/10 bg-white/5 hover:bg-white/10 text-slate-500 hover:text-white transition-all flex items-center justify-center tech-chipped"
                    >
